...
with DAG('tests_dag', description='Python DAG', schedule_interval=timedelta(1), start_date=datetime(2021, 4, 17), template_searchpath=(os.environ["AIRFLOW_HOME"]+'/dags/repo/postgres_files'), catchup=False) as dag:
	...
	t4 = PostgresOperator(task_id='insert_into_table',postgres_conn_id="postgres_default", sql="INSERT INTO clean_store_transactions(STORE_ID,STORE_LOCATION,PRODUCT_CATEGORY,PRODUCT_ID,MRP,CP,DISCOUNT,SP,Date) VALUES (YR7220,NewYork,Electronics,12254943,31,20.77,1.86,29.14,26/11/2019);")
