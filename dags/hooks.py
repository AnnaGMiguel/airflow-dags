...
def transfer_function(ds, **kwargs):
    ...
    #source hook
    source_hook = PostgresHook(postgres_conn_id='postgres_default', schema='airflow')
    source_conn = source_hook.get_conn()

    #destination hook
    destination_hook = PostgresHook(postgres_conn_id='postgres_default', schema='airflow')
